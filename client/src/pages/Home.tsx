    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50">
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              Bienvenido a{' '}
              <span className="text-primary-600">academy.iancamps.dev</span>
            </motion.h1>
      ...
      <section className="py-20 bg-secondary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-secondary-900 mb-4">
              ¿Por qué elegir nuestra Academy?
            </h2>
            <p className="text-xl text-secondary-600 max-w-2xl mx-auto">
              Ofrecemos la mejor experiencia de aprendizaje con recursos de calidad profesional
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Contenido actualizado y relevante para el mercado actual"
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Metodología eficiente para que aprendas más en menos tiempo"
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
